...
import (
	...
	"github.com/lucasmcclean/adk-go/internal/vertexai/extension"
	"github.com/lucasmcclean/adk-go/internal/vertexai/generativemodel"
	"github.com/lucasmcclean/adk-go/internal/vertexai/preview/rag"
	"github.com/lucasmcclean/adk-go/internal/vertexai/prompt"
...
func NewClient(ctx context.Context, projectID, location string, options ...option.ClientOption) (*Client, error) {
	...
	logger := otelslog.NewLogger("github.com/lucasmcclean/adk-go/internal/vertexai", otelslog.WithLoggerProvider(client.loggerProvider))
